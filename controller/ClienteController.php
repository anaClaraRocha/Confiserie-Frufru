...
//   require_once "model/cliente.php";
    ...
    class ClienteController{
        ...
        public function validaCpf($cliente){
            $existente = false;

            for($i = 0; $i < strlen($cliente->getCpfCliente()); $i++){
            //     if(strtoupper($cliente->getCpfCliente()) == strtoupper($cliente->getCpfCliente()[$i][2])) {
            //         $existente = true;
            //         break;
            //     }else{
            //         $existente = false;
        ...
        public function validaEmail($cliente){
            $existente = false;

            for($i = 0; $i < strlen($cliente->getEmailCliente()); $i++){
                // if(strtoupper($cliente->getEmailCliente()) == strtoupper($cliente->getEmailCliente()[$i][2])) {
                //     $existente = true;
                //     break;
                // }else{
                //     $existente = false;
        ...
        public function validacaoCpf($cliente){
            $cpf = $_POST['txtCpf'];
